...
import com.lumora.cloud.billing.service.SettlementService;
...
public class BillingInternalController {
    ...
    public BillingInternalController(InternalRequestAuthorizer authorizer, SettlementService settlementService) {
