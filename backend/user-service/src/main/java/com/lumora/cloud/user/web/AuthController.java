...
import com.lumora.cloud.user.service.AuthService.AuthResult;
import com.lumora.cloud.user.service.RequestMetadata;
import com.lumora.cloud.user.web.AuthContracts.AuthResponse;
import com.lumora.cloud.user.web.AuthContracts.LoginRequest;
import com.lumora.cloud.user.web.AuthContracts.LogoutRequest;
import com.lumora.cloud.user.web.AuthContracts.RefreshRequest;
import com.lumora.cloud.user.web.AuthContracts.RegisterRequest;
...
public class AuthController {
    ...
    private UserProfileResponse profile(AuthService.UserProfile profile) {
